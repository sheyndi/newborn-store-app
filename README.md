...
|--------|----------------------------|------------|----------------|-----------------------------------------------------|--------------------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------|
| GET    | /api/user/getUserDetails    | -          | userId: string | -                                                   | Returns user details by ID                  | ```json { "title": "Success", 
"message": "User details fetched successfully.", 
"data": {
     "id": "string", "first_name": "string", "last_name": "string", 
     "phone": "string", "address": "string", "profilePicture": "string", 
     "role": "string", "authMethod": "string", 
     "location": { "latitude": number, "longitude": number }, "loved_Hotels": [],
      "created_at": "date" } }``` | 400 - Missing userId<br>404 - User not found<br>500 - Server error |
